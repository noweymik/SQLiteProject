	...
	public static void main(String[] args) {
		...
		try {
			...
			while(rs1.next()) {
				...
				System.out.println(id+" "+name+" "+a_type+" "+a_year+" - 데뷔: "+debut+" "+regdate);
			...
			String sql2 = "insert into g_artists (name, a_type, a_year, debut, regdate)"
					+ " values ('SG워너비', '남성', '2000년대, 2010년대, 2020년대', '2004년', datetime('now','localtime'));";
			...
			/*String sql3 = "update g_artists set a_year = '2000년대, 2010년대' "
					+ "where id=2 ;";*/
			String sql3 = "update g_artists set regdate = datetime('now','localtime')"
					+ "where id=12 ;";
			...
			String sql4 = "delete from g_artists where debut = '1999년'; ";
